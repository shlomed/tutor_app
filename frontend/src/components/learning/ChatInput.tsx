    ...
    <form onSubmit={handleSubmit} className="border-t border-cream-300 bg-cream-50 p-3">
      <div className="flex gap-2 items-end">
        ...
        <button
          ...
          className="shrink-0 w-10 h-10 rounded-xl bg-amber-600 hover:bg-amber-500 text-white flex items-center justify-center disabled:opacity-30 disabled:cursor-not-allowed transition-all"
        >
